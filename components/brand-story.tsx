    ...
    <section id="story" className="relative py-24 md:py-32 bg-[#050505] overflow-hidden">
      <div className="mx-auto max-w-[90rem] px-4 md:px-8">
        ...
        <div className="mb-12 md:mb-16 opacity-80">
          <span className="text-xs md:text-sm font-semibold tracking-widest text-stone-500">VỀ MIXED TECHNOLOGY</span>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 md:gap-16 mb-20 md:mb-24">
          ...
          >
            <h2 className="text-3xl md:text-5xl font-medium text-stone-100 leading-[1.2] tracking-tight text-balance">
